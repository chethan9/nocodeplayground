...
# Install necessary packages, Flask, BeautifulSoup, pytz,requests, ffmpeg-python, gunicorn, parse-torrent-title, pyjwt, selenium, cinemagoer, jsmin, css_html_js_minify, pandas, openpyxl
RUN pip install --no-cache-dir flask werkzeug beautifulsoup4 ytmusicapi requests chardet ffmpeg-python gunicorn parse-torrent-title pyjwt selenium cinemagoer jsmin css_html_js_minify cssutils htmlmin instaloader instagrapi Pillow>=8.1.1 twilio pandas openpyxl
