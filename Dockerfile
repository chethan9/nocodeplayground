...
# Install necessary packages, Flask, BeautifulSoup, requests, ffmpeg-python, gunicorn, parse-torrent-title, pyjwt, selenium, cinemagoer, jsmin, css_html_js_minify, pandas, openpyxl
